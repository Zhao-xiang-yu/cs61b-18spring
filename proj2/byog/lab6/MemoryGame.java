...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        for (int i = 0; i < n; i++) {
            int charIdx = rand.nextInt(CHARACTERS.length);
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            String expectedStr = generateRandomString(round);
            flashSequence(expectedStr);
        ...
        String failedMsg = "Game Over! You made it to round: " + round;
        drawFrame(failedMsg);
        StdDraw.pause(1000);
        return;
